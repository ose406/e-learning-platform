...
<body>
  <div class="container">
    ...
    <h3>Exercise 3</h3>
      <p>Write a <code>for</code> loop that prints the numbers 2 to 20 in increments of 2.</p>
   <div id="output" class="text-center text-success"></div>
  ...
  <div class="form-group d-flex">
    ...
    <a href="loopexercise4.php" class="btn btn-success hidden next">Next</a>
  </div>
  ...
  const next=document.querySelector(".next");
      ...
      if (actualOutput === expectedOutput) {
          ...
          setTimeout(function(){
  // location.href="loopexercise4.php";
