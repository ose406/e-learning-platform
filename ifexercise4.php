<html lang="en"><head><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
  ...
  <div class="container">
    ...
    <div class="exercise_4">
      <h3>Exercise 4</h3>
      <p>Write an if statement that checks if a variable x is greater than 5 and less than 10. If it is, print "x is between 5 and 10" to the console.</p>
      <textarea id="exercise4" class="form-control"></textarea><br>
      <button type="button" class="btn btn-primary b4">Submit</button>
      <div class="next hidden">
        <a href="ifexercise5.php" class="btn btn-success">Next</a>
      </div>
      <p id="result4"></p>
      <p class="response4"></p>
    </div>
...
const  response=document.querySelector(".response4");
...
let result= document.querySelector("#result4");
        if (response.textContent=="x is between 5 and 10") {
        ...
        next.classList.remove("hidden");
          ...
          document.getElementById("result4").inner="Incorrect";
