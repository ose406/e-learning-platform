<html lang="en"><head><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
  ...
  <div class="container">
    ...
    <!-- <div class="exercise hidden">
      <h3>Exercise 1</h3>
      <p>Write an if statement that checks if a variable x is greater than 5. If it is, print "x is greater than 5" to the console.</p>
    ...
    <!-- <div class="exercise_2 hidden">
      ...
      <textarea id="exercise2" class="form-control"></textarea><br><br>
      <button class="btn btn-primary b2">Submit</button>
      <p id="result2"></p>
      <p class="response3"></p>
    ...
    <div class="exercise_3 ">
      <h3>Exercise 3</h3>
      <p>Write an if statement that checks if a variable z is equal to 20. If it is, print "z is equal to 20" to the console.</p>
      <textarea id="exercise3" class="form-control"></textarea><br>
      <button class="btn btn-primary b3">Submit</button>
      <div class="next hidden">
        <a href="ifexercise4.php" class="btn btn-success">Next</a>
      </div>
      <p id="result3"></p>
      <p class="response3"></p>
    </div>
...
let result= document.querySelector("#result3");
        if (response.textContent=="z is equal to 20") {
         ...
         result.innerHTML="Correct! <br/>Good Job";
          ...
          document.getElementById("result3").innerHTML="<b>Incorrect</b>";
