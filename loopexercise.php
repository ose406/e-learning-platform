...
<body>
  ...
  <div class="exercise_1">
    <h3>Exercise 1</h3>
    <p>Write a <code>for</code> loop that prints the numbers 1 to 10 to the console.</p>
    <div class="row">
      <div class="col-md-6">
    <div id="output"></div>
  ...
  <div class="col-md-6">
    <a href="loopexercise2.php" class="btn btn-success next hidden">Next</a>
  </div>
</div>
...
runCodeButton.addEventListener('click', () => {
    ...
    if (actualOutput === expectedOutput) {
        ...
        setTimeout(function(){
// location.href="loopexercise2.php";
