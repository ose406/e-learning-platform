...
<body>
  ...
  <h3>Exercise 4</h3>
  <p>Write a <code>while</code> loop that prints the numbers 1 to 10, but skips the number 5.</p>
 <div id="output"></div>
...
<a href="loopexercise5.php" class="btn btn-success next hidden">Next</a>
</div>
  </div>
<script>
// JavaScript
